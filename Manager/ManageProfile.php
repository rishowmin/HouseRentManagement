    ...
    <div class="container-fluid">
                    ...
                    <div class="ml-auto d-flex align-items-center">
                        <nav>
                            <ol class="breadcrumb p-0 m-b-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">UsManage Profile</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <?php
            if(isset($_SESSION['auth'])){
                ...
                $userFName = $_SESSION['auth_user']['user_first_name'];
                $userLName = $_SESSION['auth_user']['user_last_name'];
        ?>
                                                        ...
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" id="userID" value="<?php echo $userID; ?>">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="userFirstName">First Name</label>
                                                                    <input type="text" class="form-control" id="userFirstName" value="<?php echo $userFName; ?>">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="userLastName">Last Name</label>
                                                                    <input type="text" class="form-control" id="userLastName" value="<?php echo $userLName; ?>">
                                                                </div>
                                                                <div class="form-group col-md-12">
