                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <div class="mb-2 input-group date" id="expense-month">
                                                                                            <input type="text" class="form-control" id="expMonth" name="expMonth" value="<?php if(isset($_GET['filter_data'])){ echo $_GET['expMonth']; } ?>" placeholder="Expense Month" />
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">                                                                                            
                                                                                        <div class="mb-2 input-group date" id="from-date">
                                                                                            <input type="text" class="form-control" id="fromDate" name="fromDate" value="<?php if(isset($_GET['filter_data'])){ echo $_GET['fromDate']; } ?>" placeholder="From Date" />
                                                                                            <span class="input-group-addon">
                                                                                                <i class="fa fa-calendar"></i>
                                                                                            </span>
                                                                                        </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <div class="mb-2 input-group date" id="to-date">
                                                                                            <input type="text" class="form-control" id="toDate" name="toDate" value="<?php if(isset($_GET['filter_data'])){ echo $_GET['toDate']; } ?>" placeholder="To Date" />
                                                                                            <span class="input-group-addon">
                                                                                                <i class="fa fa-calendar"></i>
                                                                                            </span>
                                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <div class="list-imp-btn mb-2 text-right">
                                                                                            <button class="btn btn-info btn-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="Print"><i class="fa fa-print"></i></button>
                                                                                            <button class="btn btn-warning btn-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="Genarate PDF"><i class="fa fa-file-pdf-o"></i></button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                            ...
                            <div id="all-data" class="col-lg-12">
                                <div class="card card-statistics">
                                            ...
                                            <table class="display compact table table-striped table-bordered">
                                                ...
                                                <?php
                                                    if(isset($_GET['search'])){                                                        
                                                        ...
                                                        $select_expense = "SELECT * FROM tblexpense WHERE
                                                ...
                                                <?php
                                                    ...
                                                    elseif(isset($_GET['fromDate']) && isset($_GET['toDate']) || isset($_GET['expHead']) || isset($_GET['expMonth'])){
                                                        ...
                                                        if(($fromDate != "") && ($toDate != "") || ($expHead != "") || ($expMonth != "")){
                                                            ...
                                                            $select_expense = "SELECT * FROM tblexpense 
                                                                WHERE expense_date BETWEEN '$fromDate' AND '$toDate' OR expense_head='$expHead' OR expense_month='$expMonth' AND ysnactive='1' 
                                                                ORDER BY id ASC LIMIT $offset, $total_records_per_page";
                                                            $run_select_qry = mysqli_query($conn, $select_expense);
                                                    ...
                                                    <?php
                                                        ...
                                                        $select_expense = "SELECT * FROM tblexpense WHERE ysnactive='1' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
                                                        $run_select_qry = mysqli_query($conn, $select_expense);
                                                        while ($row_expense = mysqli_fetch_array($run_select_qry)){
                                                            $expenseID = $row_expense['expense_id'];
                                                            $expenseInvoiceNo = $row_expense['e_invoice_no'];
