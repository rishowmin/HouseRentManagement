                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                    ...
                                    <div class="ml-xl-4 mt-xl-0 ml-0 mt-3 d-flex align-items-center">
                                        <div class="dropdown">
                                            <a class="btn btn-dark" href="#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Add New
                                            </a>
                                            <div class="dropdown-menu custom-dropdown dropdown-menu-right dropdown-menu-left-mobile p-4">
                                                <a class="dropdown-item" href="AddRole.php"><i class="ti ti-medall-alt"></i>Role </a>
                                                <a class="dropdown-item" href="AddUser.php"><i class="ti ti-user"></i>User </a>
                                                <a class="dropdown-item" href="AddRenter.php"><i class="ti ti-briefcase"></i>Renter </a>
                                                <a class="dropdown-item" href="AddFlat.php"><i class="ti ti-layout"></i>Flat </a>
                                                <a class="dropdown-item" href="AddRent.php"><i class="ti ti-direction"></i>Rent </a>
                                                <a class="dropdown-item" href="AddBill.php"><i class="ti ti-direction-alt"></i>Bill</a>
                                                <a class="dropdown-item" href="AddExpense.php"><i class="ti ti-server"></i>Expense</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
